...
// =====================================================================
// DBManager — Singleton (patrón del profesor Paz)
//   - Lee datos.properties (ResourceBundle) -> arma la URL JDBC.
//   - Ejecuta procedimientos almacenados con parámetros POSICIONALES
//     usando Map<Integer,Object> (clave = posición del ?, valor = dato).
//   - Soporta lectura, escritura simple y transacciones maestro-detalle.
// IMPORTANTE: datos.properties + el driver MySQL deben vivir en el WAR del WS,
//             no aquí. Este módulo solo aporta la clase.
// =====================================================================
