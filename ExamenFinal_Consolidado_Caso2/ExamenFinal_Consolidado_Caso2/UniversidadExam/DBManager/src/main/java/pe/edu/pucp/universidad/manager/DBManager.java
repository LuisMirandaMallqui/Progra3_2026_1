package pe.edu.pucp.universidad.manager;
...
public class DBManager {
    ...
    private DBManager() {
        ...
        if (this.tipoBD.equals("mysql")) {
            this.url = "jdbc:mysql://" + hostnameMySQL + ":" + puertoMySQL + "/" + esquema + "?useSSL=false";
    ...
    private void registrarParametrosEntrada(
        ...
        for (Map.Entry<Integer, Object> entry : parametros.entrySet()) {
            ...
            switch (value) {
                ...
                case java.time.LocalDate fecha -> cs.setDate(key, Date.valueOf(fecha));
